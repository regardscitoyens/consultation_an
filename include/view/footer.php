<div class="container">
      <div id="faq" class="row">
        ...
        <div class="col-md-offset-2 col-md-8">
          ...
          <p>N'hésitez pas à nous faire un petit mail à contact@regardscitoyens.org ou à poster un commentaire sur les réseaux sociaux avec le hashtag <a target="_blank" href="https://twitter.com/search?f=tweets&q=ConsultEgalit%C3%A9">#ConsultEgalité</a>.</p>
        </div>
      </div>
      <div id="a-propos" class="row">
        ...
        <div class="col-md-offset-2 col-md-8">
          ...
          <p>Merci à <a href="https://commons.wikimedia.org/wiki/File:Assembl%C3%A9e_Nationale_%C3%A0_l%27heure_bleue,_Paris,_France.jpg?uselang=fr" target="_blank">Getfunky Paris</a> pour sa photo de <a href="./img/parlement-nuit-background-1.jpg" target="_blank">l'Assemblée nationale</a>.</p>
