...
<div class="form-group">
  ...
  <div class="row">
    ...
    <div class="checkbox col-md-6"><label><input type="checkbox" name="affirmations|des informations ou données sur le problème">des informations ou données sur le problème</label></div>
    ...
    <div class="checkbox col-md-6"><label><input type="checkbox" name="affirmations|des prises de position contre une mesure existante">des prises de position contre une mesure existante</label></div>
    <div class="checkbox col-md-6"><label><input type="checkbox" name="affirmations|des propositions de nouvelles mesures">des propositions de nouvelles mesures</label></div>
    <div class="checkbox col-md-6"><label><input type="checkbox" name="affirmations|des questions ou demandes d'information">des questions ou demandes d'information</label></div>
    <div class="checkbox col-md-6"><label><input type="checkbox" name="affirmations|des prises de position en faveur d'une mesure existante">des prises de position en faveur d'une mesure existante</label></div>
  </div>
</div>
<div class="form-group">
